...
const contacts = [
  ...
  { label: 'Telefon', val: '+381 64 261 4867', href: 'tel:+381642614867', external: false },
]
      ...
      <div style={{ maxWidth: 920, margin: '0 auto' }}>
        <motion.div {...A}>
          ...
          <h2 className="section-title">
            Tražim tim,{' '}
            <span style={{ color: 'var(--red)' }}>ne samo projekat.</span>
          </h2>
          <p className="body-text" style={{ maxWidth: 580 }}>
            Otvoren sam za full-time poziciju u marketing ili social media timu. Donosim metod
            za sadržaj koji zaustavlja skrolovanje, iskustvo sa realnim rezultatima i dve
            decenije rada sa ljudima — tamo gde je customer experience sve.
          </p>
        </motion.div>
